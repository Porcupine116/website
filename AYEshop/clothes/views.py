...
def shoes_man(request):
    clothes = Articles.objects.all()
    return render(request, 'clothes/shoes_man.html', {"clothes": clothes})


def shoes_woman(request):
    clothes = Articles.objects.all()
    return render(request, 'clothes/shoes_woman.html', {"clothes": clothes})


def shoes_home(request):
    clothes = Articles.objects.all()
    return render(request, 'clothes/shoes_home.html', {"clothes": clothes})


def accessories(request):
    clothes = Articles.objects.all()
    return render(request, 'clothes/accessories_home.html', {"clothes": clothes})


def new(request):
    return render(request, 'clothes/new_home.html')
